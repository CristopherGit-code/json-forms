...
class LLM_Open_Client:
    ...
    def _init(self):
        if self._initialized:
            return
        self.config_file_path = os.environ.get("SANDBOX_PATH")
    ...
    def load_config_file(self):
        ...
        oci_agent_config = config['oci_agent']
        self.config_file = oci_agent_config['configFile']
        self.profile = oci_agent_config['profile']
        self.compartment = os.environ.get("COMPARTIMENT")
        self.endpoint = oci_agent_config['endpoint']
